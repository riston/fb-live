...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phoenix_html__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__socket__ = __webpack_require__(4);




__WEBPACK_IMPORTED_MODULE_1__socket__["a" /* default */].connect()

const a = [123,432,3];

a.map(d => {console.log(d + 23)});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phoenix__ = __webpack_require__(2);
...
let channel = socket.channel("command:lobby", {});
...
channel.on("increment", onIncrement);
channel.push("increment", { value: 1 });
...
channel.on("summary", summary => {
  console.log(summary);
  right$.textContent = summary.like;
  left$.textContent = summary.wow;
});

channel.on("reaction", reaction => {
