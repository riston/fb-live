...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phoenix_html__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__socket__ = __webpack_require__(7);
...
const bounceAnimation = element => {
  const tl = new __WEBPACK_IMPORTED_MODULE_1_gsap__["TimelineMax"]()
...
const pulse = new __WEBPACK_IMPORTED_MODULE_1_gsap__["TimelineMax"]({
...
const onAvatar = avatar => {
  ...
  avatarImg.onload = () => {
    ...
    if (avatars.length >= MAX_AVATARS) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenMax"].to(avatarToRemove, 1, {
        bottom: "100px",
        opacity: 0,
    ...
    __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenMax"].to(avatarImg, 0.5, {
      opacity: 1,
...
const channel = __WEBPACK_IMPORTED_MODULE_2__socket__["a" /* default */].channel(CHANNEL_NAME, {});
channel
  .join()
  .receive("ok", onOK)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phoenix__ = __webpack_require__(3);
...
let socket = new __WEBPACK_IMPORTED_MODULE_0_phoenix__["Socket"]("/socket");
